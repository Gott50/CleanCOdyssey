...
//	Gibt die Koordinaten der non-trivial zur KŸrzende Elemente wieder, wenn nicht vorhanden {-1,-1}
...
//	prŸft, ob non-trivial gekŸrzt werden kann
...
//	wandelt ein int[] wieder in eine Zahl um, aber lŠsst die Ziffer auf pos aus
	String str = "";
	for(int i = 0; i < z.length; i++){
	    if(i != pos)
	    str = str + z[i];
